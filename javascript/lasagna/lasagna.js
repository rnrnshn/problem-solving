 ...
 */
export function totalTimeInMinutes(preparationTimeInMinutes, actualMinutesInOven) {
  return actualMinutesInOven + preparationTimeInMinutes * PREPARATION_MINUTES_PER_LAYER;
}
